        ...
        <div className="BookClues font">
            <HTMLFlipBook width={300} height={420} size="stretch" position="absolute">
                ...
                <div className="rightPage">
                    <h3 style={{ margin: "10%" }}>May 27, 1927</h3>
                ...
                <div className="position-absolute">
                    <h3 style={{ margin: "10%" }}>June 2, 1927</h3>
                    ...
                    <img className="bookArrow position-absolute bottom-0 start-50 translate-middle-x" src={require('../img/bookArrow.png')} alt="arrow" />
                </div>

                </div>
                <div className="rightPage">
                    <h3 style={{ margin: "10%" }}>June 9, 1927</h3>
                    <h5 style={{ marginLeft: "15%", marginRight: "15%" }}>Under normal circumstances, I would have already been back to the comforts of my humble abode by this day. However, a storm quickly changed my plans. As I awaited for the passage of the storm in a small cave I happened to find, I began thinking of what lies beyond the woods, the valley, the four walls of my cabin. I closed my eyes and thought of a bright sunny beach, with warm sand and clear waters. These past few years have not been so kind to me as what I once called my ailments have now become persistent, worsening... disabling. I have even started to forget most things. To jog my memory, I left clues around the cabin in order to important things.</h5>
                </div>
                <div className="leftPage"><h3 style={{ margin: "10%" }}>December 15, 1927</h3>
