...
const BookshelfView = (props) => {
    ...
    const [isLettersVisible, setLettersVisible] = useState(false);
    ...
    return (
        <div className="gameWindow position-relative">
            ...
            {/* <img className="book position-absolute top-50 start-0 translate-middle-y clickable" src={require('../img/book.png')} alt="Book" /> */}
