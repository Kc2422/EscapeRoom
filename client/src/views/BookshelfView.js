...
const BookshelfView = (props) => {
    ...
    return (
        <div className="gameWindow position-relative" >
            ...
            <img className="lamp position-absolute top-0 start-0 translate-middle clickable" onClick = {onClickLamp} src={require('../img/lamp.png')} alt='Lamp' />
            ...
            {isBook && (
                <img className="book position-absolute top-50 start-50 translate-middle-y clickable" src={require('../img/book.png')} alt="Book" onClick={book} />
            )}
