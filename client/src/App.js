  ...
  return (
    <div >
      ...
      <Route exact path="/door">
        <FrontDoorView sidebar={sidebar} text={text} name={name} submitted={submitted} solvedPuzzle1={solvedPuzzle1}/>
      </Route>

      <Route exact path="/bookshelf">
        <BookshelfView sidebar={sidebar} text={text} name={name} submitted={submitted} solvedPuzzle1={solvedPuzzle1}/>
      </Route>
